...
from lib import Subscription, Member, News
...
if __name__ == '__main__':
    ...
    engine = create_engine('sqlite:///lib/sportif.db')
    Session = sessionmaker(bind=engine)
    session = Session()

    ## USSD implementation
    while True:
        response = input("Dial *888# and press send: ")
        if response == "*888#":
            print("\nWelcome to Sportif(Your USSD sport news app)!")
            ...
            print("Invalid input. Please dial *888# and press send.")
